        ...
        <Box as="form" width="100%" onSubmit={handleSubmit}>
          <VStack spacing={4}>
              <FormControl id="gene" isRequired>
                ...
                value={formData.gene}
                onChange={(e: ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, gene: e.target.value })}
                size="sm"
                />
              </FormControl>
              ...
              <FormControl id="variation" isRequired>
                ...
                onChange={(e: ChangeEvent<HTMLInputElement>) => setFormData({ ...formData, variation: e.target.value })}
                size="sm"
                />
              </FormControl>
              ...
              <FormControl id="text" isRequired>
                ...
                value={formData.text}
                onChange={(e: ChangeEvent<HTMLTextAreaElement>) => setFormData({ ...formData, text: e.target.value })}
                size="sm"
                />
              </FormControl>            <Button
              type="submit"
            ...
            <CardBody>
              <VStack align="start" spacing={4}>
                ...
                <Box width="100%">
                  ...
                  {(Object.entries(prediction.class_probabilities) as Array<[string, number]>).map(([className, prob]) => (
